...
const inputClass =
  "block w-full pl-10 pr-3 py-3 border border-white/50 bg-white/50 backdrop-blur-md rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all text-sm shadow-sm placeholder:text-gray-400";
const inputNoIconClass =
  "block w-full px-3 py-3 border border-white/50 bg-white/50 backdrop-blur-md rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all text-sm shadow-sm placeholder:text-gray-400";
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <div className="relative">
          ...
          <input type="text" value={formData[alamatKey]} onChange={(e) => onChange(alamatKey, e.target.value)}
            className={inputClass + dis} placeholder="Jl. Jimerto No.28" required disabled={disabled} />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className={labelClass}>Kelurahan / Desa <span className="text-red-500">*</span></label>
          {disabled
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className={labelClass}>Kota / Kabupaten <span className="text-red-500">*</span></label>
          {disabled
      ...
      <div className="sm:w-1/2">
        <label className={labelClass}>Kode Pos <span className="text-red-500">*</span></label>
