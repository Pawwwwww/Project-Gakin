...
export default function UserAccount() {
  ...
  return (
    <AdminLayout title="User Account" headerIcon={<Users className="w-4 h-4" />}>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
        ...
        <UserCheck className={`w-16 h-16 mb-4 ${isDark ? "text-gray-600" : "text-gray-400"}`} />
        <p className={`text-center font-medium text-lg ${textSecondary}`}>User Account Management</p>
